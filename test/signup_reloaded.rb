...
class SignupReloaded < Test::Unit::TestCase
...
#	options.secure_ssl = false
#	options.accept_untrusted_certs = true
       @browser = Selenium::WebDriver.for :firefox, options:options
       @browser.get 'https://reloaded.online/signup'
       ...
       @terms = @browser.find_element(:class, "icheckbox_square-green")
       @terms.click
