...
class CreateOptions < ActiveRecord::Migration
  ...
  def self.load
    ...
    Option.create :name => "PROJECT_KEYWORDS",:value => "Consultancy, Software Development, CyberSecurity"
    ...
    Option.create :name => "CONTACT_EMAIL",:value => "info@reloaded.com"
    ...
    Option.create :name => "MAILER_BCC",:value => "d4x337@reloaded.com"
    Option.create :name => "DIR_CODE",:value => "asgana123"
    Option.create :name => "CONTRIBUTION",:value => "1000"
    Option.create :name => "COMPANY",:value => "Reloaded BV"
